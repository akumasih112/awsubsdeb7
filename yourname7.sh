JScriptCodeDom.CodeParseException: StartIndex cannot be less than zero.
Parameter name: startIndex , Line 1, Char 0 ---> System.ArgumentOutOfRangeException: StartIndex cannot be less than zero.
