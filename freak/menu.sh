...
show_menu(){
	...
	echo -e "${NORMAL}==========================================================="
    echo -e "${LRED}OpenSSH            : ${BLUE}22, 143, 80"
    echo -e "${LRED}SSL/TLS            : ${BLUE}443"
	echo -e "${LRED}Dropbear           : ${BLUE}3128, 109, 110"
	echo -e "${LRED}SquidProxy         : ${BLUE}$IP:8080, 8000 (limit to IP SSH)"
